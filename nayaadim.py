...
░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░  ░▒▓█▓▒░          ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
 ░▒▓██████▓▒░░▒▓█▓▒░░▒▓█▓▒░  ░▒▓█▓▒░          ░▒▓█▓▒░░▒▓█▓▒░▒▓███████▓▒░░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
   ...
   ____         _  ____     ___              _     ________  ___       ________      ___
  6MMMMb/      dM. `MM(     )M'             dM.    `MMMMMMMb.`MMb     dMM`MM`MM\     `M'
 8P    YM     ,MMb  `MM.    d'             ,MMb     MM    `Mb MMM.   ,PMM MM MMM\     M 
6M      Y     d'YM.  `MM.  d'              d'YM.    MM     MM M`Mb   d'MM MM M\MM\    M 
MM           ,P `Mb   `MM d'              ,P `Mb    MM     MM M YM. ,P MM MM M \MM\   M 
MM           d'  YM.   `MM'               d'  YM.   MM     MM M `Mb d' MM MM M  \MM\  M 
MM     ___  ,P   `Mb    MM               ,P   `Mb   MM     MM M  YM.P  MM MM M   \MM\ M 
MM     `M'  d'    YM.   MM               d'    YM.  MM     MM M  `Mb'  MM MM M    \MM\M 
YM      M  ,MMMMMMMMb   MM              ,MMMMMMMMb  MM     MM M   YP   MM MM M     \MMM 
 8b    d9  d'      YM.  MM              d'      YM. MM    .M9 M   `'   MM MM M      \MM 
  YMMMM9 _dM_     _dMM__MM_           _dM_     _dMM_MMMMMMM9'_M_      _MM_MM_M_     
